...
import { CustomAttributeResource, ICustomAttribute } from '@aurelia/runtime';
...
import { IRenderStrategy, RenderStrategyResource } from '@aurelia/runtime';
...
export class Renderer implements IRenderer {
  ...
  public hydrateElementInstance(
    renderable: IRenderable,
    target: INode,
    instruction: Immutable<IHydrateElementInstruction>,
    component: ICustomElement & PIXI.Container
  ): void {
  ...
  public [TargetedInstructionType.hydrateElement](renderable: IRenderable, target: any, instruction: Immutable<IHydrateElementInstruction>): void {
    ...
    const component = context.get<ICustomElement & PIXI.Container>(CustomElementResource.keyFrom(instruction.res));
