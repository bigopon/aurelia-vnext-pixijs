...
export interface IInternalCustomElementImplementation extends Writable<ICustomElement> {
  ...
  $encapsulationSource: PIXI.Container;
}
...
function hydrate(
  this: IInternalCustomElementImplementation,
...
function attach(this: IInternalCustomElementImplementation, encapsulationSource: PIXI.Container, lifecycle: IAttachLifecycle): void {
  if (this.$isAttached) {
    return;
  }
...
export interface IElementProjector {
  readonly host: PIXI.Container;
  readonly children: ReadonlyArray<PIXI.DisplayObject>;

  provideEncapsulationSource(parentEncapsulationSource: PIXI.Container): PIXI.Container;
...
export class ShadowDOMProjector implements IElementProjector {
  public shadowRoot: PIXI.Container;
  ...
  public provideEncapsulationSource(parentEncapsulationSource: PIXI.Container): PIXI.Container {
...
//   private childNodes: ArrayLike<PIXI.Container>;
...
//   get children(): ArrayLike<PIXI.Container> {
...
export class HostProjector implements IElementProjector {
  constructor(customElement: ICustomElement, public host: PIXI.Container) {
    (host as any).$customElement = customElement;
  }

  get children(): ReadonlyArray<PIXI.DisplayObject> {
