    ...
    if (definition && definition.templateOrNode) {
      if (definition.build.required) {
        ...
        definition = compiler.compile(
          <ITemplateSource>definition,
          new RuntimeCompilationResources(<ExposedContext>parentContext),
...
export class CompiledTemplate implements ITemplate {
  ...
  public createFor(renderable: IRenderable, host?: PIXI.Container, replacements?: TemplatePartDefinitions): INodeSequence {
...
export class RuntimeCompilationResources implements IResourceDescriptions {
  ...
  public create<TSource, TType extends IResourceType<TSource>>(
    kind: IResourceKind<TSource, TType>,
    name: string
