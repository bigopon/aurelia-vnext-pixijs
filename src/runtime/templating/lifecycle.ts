...
export interface IAttach {
  ...
  $attach(encapsulationSource: PIXI.Container, lifecycle: IAttachLifecycle): void;
...
class AttachLifecycleController implements IAttachLifecycle, IAttachLifecycleController {
  ...
  constructor(
    ...
    private encapsulationSource: PIXI.Container = null
  ) {
...
export const Lifecycle = {
  beginAttach(encapsulationSource: PIXI.Container, flags: LifecycleFlags): IAttachLifecycleController {
